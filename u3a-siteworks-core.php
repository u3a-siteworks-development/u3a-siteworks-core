...
define('U3A_SITEWORKS_CORE_VERSION', '1.1.6');
// Set to current plugin version number

// Check for metabox plugin present and activated
if ((require_once "inc/check-metabox.php") == false) {
    return;
}
...
//  Defines constants used in all classes
require_once 'inc/traits.php';
//  Defines functions that can be shared by all classes
