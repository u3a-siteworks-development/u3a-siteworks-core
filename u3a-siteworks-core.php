...
define('U3A_SITEWORKS_CORE_VERSION', '2.0.0'); // Set to current plugin version number
...
require_once "classes/class-u3a-eventseries.php";
U3aEventSeries::initialise(__FILE__);
