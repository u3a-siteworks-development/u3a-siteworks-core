...
class U3aCommon // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace
{
...
// Context is edit in the editor
     ...
     * NB Function uses the heading text in spans to identify panels to remove.
     * If text changes this function will need corresponding changes.
     *
